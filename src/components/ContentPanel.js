...
export function ContentPanel(domain, { level = 'core', lang = 'en', graphViewer, signal } = {}) {
  const el = document.createElement('aside')
  el.className = 'cb-content-panel'

  const conceptIndex = new Map()
  _fillConceptIndex(conceptIndex, domain)
  // Default to 'sonnet', the model this app's books are generated with. The
  // dropdown always reflects a real, generatable model, never an empty '' that
  // displays as "— default —" but isn't a value the backend/catalog recognizes.
